...
% vp{5} = struct('s',0.21, 'pos', [0.11; 0.21; 0.11] , 'err_tol',err_tol);
% vp{6} = struct('s',0.23, 'pos', [0.15; 0.25; 0.15] , 'err_tol',err_tol);
vp{2} = struct('s',0.4, 'pos', [0.1; -0.3; 0.1], 'err_tol',err_tol);
% vp{4} = struct('s',0.8, 'pos', [-0.1; 0.2; -0.2], 'err_tol',err_tol);
