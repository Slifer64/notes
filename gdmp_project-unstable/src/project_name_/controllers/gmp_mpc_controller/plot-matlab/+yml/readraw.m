function result = readraw(filename, verbose, nosuchfileaction, treatasdata)
%==========================================================================
...
%--------------------------------------------------------------------------
% Transforms Java Date class to MATLAB Datenum / DateTime class
%
function result = scan_datetime(r)
%     result = DateTime(r); % Transforms Java Date class to MATLAB DateTime class
    result = yml.tools.DateTime(r); % Transforms Java Date class to MATLAB DateTime class
%    result = double(yml.tools.DateTime(r));
end
