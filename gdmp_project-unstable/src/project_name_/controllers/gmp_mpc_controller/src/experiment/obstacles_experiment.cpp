...
ObstaclesExperiment::ObstaclesExperiment(GmpMpcController *ctrl_)
{
  ...
  // pub_path.reset(new rviz_::PathPublisher(ctrl_->marker_array_topic, ctrl_->base_link, "obstacles_online_path"));
  // pub_ref_path.reset(new rviz_::PathPublisher(ctrl_->marker_array_topic, ctrl_->base_link, "obstacles_online_ref_path"));
