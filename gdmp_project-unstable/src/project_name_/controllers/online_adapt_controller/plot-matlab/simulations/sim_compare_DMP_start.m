...
% vel_lim = vel_lim + 10*[-1 1];
% accel_lim = accel_lim + 10*[-1 1];
...
%% Simulate
[Time, P_data, dP_data, ddP_data] = simulateModel(@DMP_pp, gmp, y0, g, Tf, dt, mult_*pos_lim, mult_*vel_lim, mult_*accel_lim, slack_limits, opt_metric, via_points);

% Time2 = nan; P2_data = nan; dP2_data = nan; ddP2_data = nan;
[Time2, P2_data, dP2_data, ddP2_data] = simulateModel(@DMP_classic, gmp, y0, g, Tf, dt, mult_*pos_lim, mult_*vel_lim, mult_*accel_lim, slack_limits, opt_metric, via_points);

% Timed = Time;
% Pd_data = P_data;
% dPd_data = dP_data;
% ddPd_data = ddP_data;
% save('data/demo_data3.mat', 'Timed', 'Pd_data', 'dPd_data', 'ddPd_data');
% return
