...
public:
  Graph(QCPCurve *qcp_graph, Axes *parent = 0);
  ...
  void addData(const arma::rowvec &x, const arma::rowvec &y);
...
signals:
  ...
  void addDataSignal(double x, double y);
  void addDataSignal(const arma::rowvec &x, const arma::rowvec &y);
...
private slots:
  ...
  void addDataSlot(double x, double y);
  void addDataSlot(const arma::rowvec &x, const arma::rowvec &y);
