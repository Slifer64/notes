...
public:
  ...
  LWR4p_Robot(bool use_sim, const std::string &robot_desc, const std::string &base_link, const std::string &tool_link, const std::string &ftsensor_link, double ctrl_cycle);
  ~LWR4p_Robot();
...
private:
  ...
  void init(bool use_sim, const std::string &robot_desc, const std::string &base_link, const std::string &tool_link, const std::string &ftsensor_link, double ctrl_cycle);
