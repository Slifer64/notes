...
public:
  ...
  Ur_Robot(const std::string &robot_desc, const std::string &base_link, const std::string &tool_link,
  const std::string &ftsensor_link, const std::string &robot_ip, const std::string &host_ip, int reverse_port);

  ~Ur_Robot();

  std::vector<bool> getDigitalIn() const { return robot->getDigitalIn(); }
  ...
  void setJointsVelocity(const arma::vec &jvel) override { jvel_cmd.set(jvel); }
...
private:
  ...
  void init(const std::string &robot_desc, const std::string &base_link, const std::string &tool_link,
  const std::string &ftsensor_link, const std::string &robot_ip, const std::string &host_ip, int reverse_port);
